...
if(isset($_POST['btnsave'])){
  ...
  $con =$_POST['con'];
	...
	if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
  	...
  	$insert_data = "INSERT INTO music (item,det,qty,con,image) VALUES ('$item','$det','$qty','$con','$image')";
	...
	if(ISSET($_REQUEST['id'])){
		...
		$conn->query("DELETE FROM `music` WHERE `id`='$id'") or die("Failed to delete a row!");
...
<img src="logo.png" width="50%" >
  ...
  <h4 style="color: white;" >Music Assets</h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="music.php?id=<?php echo $fetch['id']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Yes</a>
            </div>
