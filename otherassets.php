...
if(isset($_POST['btnsave'])){
	...
	if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
  	...
  	$insert_data = "INSERT INTO others (item,det,qty,image) VALUES ('$item','$det','$qty','$image')";
	...
	if(ISSET($_REQUEST['id'])){
		...
		$conn->query("DELETE FROM `others` WHERE `id`='$id'") or die("Failed to delete a row!");
...
<img src="logo.png" width="50%" >
  ...
  <h4 style="color: white;" >Other Assests</h4>
  <br/><br/><br/><br/>
...
include_once('connection.php');
   ...
   $query=$conn->query("SELECT * FROM `others`") or die("Failed to fetch row!");
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="otherassets.php?id=<?php echo $fetch['id']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Yes</a>
            </div>
...
<tr><td><h1>The Total</h1></td> <td><h1></h1></td></tr>
</table>
</div>
</div>
</div>
