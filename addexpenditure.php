...
<img src="logo.png" width="50%" >
	...
	<br/><br/><br/><br/>
       ...
       <div class="container">
       	...
       	<a href="addincome.php"><h4 style="color: white;" >Income</h4></a>

<h3>Add Expenditure</h3>
   <form method="POST" action="expenditure.php" enctype="multipart/form-data">
                 <div class="row">
				...
				<center><button class="btn btn-primary" onclick="return mess();" name="addex">Add Expenditure</button></center>
			</div>
			</form>
