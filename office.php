...
if(isset($_POST['btnsave'])){
   ...
   $con =$_POST['con'];
	...
	if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
  	...
  	$insert_data = "INSERT INTO office (item,det,qty,con,image) VALUES ('$item','$det','$qty','$con','$image')";
	...
	if(ISSET($_REQUEST['id'])){
		...
		$conn->query("DELETE FROM `office` WHERE `id`='$id'") or die("Failed to delete a row!");
...
<img src="logo.png" width="50%" >
  ...
  <h4 style="color: white;" >Office Assets</h4>
  <br/><br/><br/><br/>
</div><br/><br/>
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                      <input type="file" class="cck" name="image" id="fileName" accept="image/*">
                      </div>
                    </div>
                  </div>
...
include_once('connection.php');
   ...
   $query=$conn->query("SELECT * FROM `office`") or die("Failed to fetch row!");
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="office.php?id=<?php echo $fetch['id']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Yes</a>
            </div>
...
<div class="modal fade" id="form_modal<?php echo $fetch['id'];?>" style="color: black;" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										<form method="POST" action="editoffice.php" >
											<div class="modal-header">
