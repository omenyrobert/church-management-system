...
<body class="container">
	<div class="row"  style="background-color: white; width: 1800;">
...
<img src="logo.png" width="50%" >
	...
	<h4 style="color: white;" >All Expenenses</h4>
	<br/><br/><br/><br/>
	<br/><br/>
</div><br/><br/>
	<div class="row">
...
include_once('connection.php');
 ...
 $sql=$conn->query("SELECT SUM(amount) AS sum FROM `expense`") or die("Failed to fetch row!");
   ...
   $query=$conn->query("SELECT * FROM `expense` ") or die("Failed to fetch row!");
...
<tr><td colspan="2" ><h1>The Total</h1></td>   <td><h1><?php echo $output;?></h1></td></tr>
</table>
			</div>
		</div>
	</div>
