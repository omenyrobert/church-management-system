...
<body class="container">
	<div class="row"  style="background-color: white; width: 1000;">
...
<a href="income.php">back</a>
			...
			<div class="row">
				...
				<table id="myTable" style="width: 80%; margin-left: 50px; color: black; background-color: white;" class="table table-bordered">
...
include_once('connection.php');
 ...
 $sql=$conn->query("SELECT SUM(amount) AS sum FROM `give`") or die("Failed to fetch row!");
   ...
   $query=$conn->query("SELECT * FROM `give` ") or die("Failed to fetch row!");
