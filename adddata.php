...
if(isset($_POST['addd'])){
	...
	if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
  	...
  	$insert_data = "INSERT INTO `church`(name, dob, gender, address, contact, ministry, background, image,reason, membership,leader) VALUES
  	 ('$name', '$dob', '$gender', '$address', '$contact', '$ministry', '$background', '$image','','$membership','$leader')";
